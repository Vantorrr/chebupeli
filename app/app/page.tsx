  ...
  const loadCountries = async () => {
    try {
      ...
      setCountries([
        ...
        { id: '3', name: 'Турция', code: 'TR', price: '$5.00 USD', priceUsd: 5.00, flag: '🇹🇷', region: 'Европа' },
        { id: '4', name: 'ОАЭ', code: 'AE', price: '$6.00 USD', priceUsd: 6.00, flag: '🇦🇪', region: 'Ближний Восток' },
        { id: '5', name: 'Египет', code: 'EG', price: '$7.00 USD', priceUsd: 7.00, flag: '🇪🇬', region: 'Африка' },
        { id: '6', name: 'Испания', code: 'ES', price: '$4.50 USD', priceUsd: 4.50, flag: '🇪🇸', region: 'Европа' },
        { id: '7', name: 'Италия', code: 'IT', price: '$4.50 USD', priceUsd: 4.50, flag: '🇮🇹', region: 'Европа' },
        { id: '8', name: 'Греция', code: 'GR', price: '$5.00 USD', priceUsd: 5.00, flag: '🇬🇷', region: 'Европа' },
      ])
    } finally {
      setLoading(false)
    }
